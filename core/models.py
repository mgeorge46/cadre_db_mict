...
class SystemSettings(models.Model):
    ...
    email_from_name = models.CharField(max_length=100, default='Ministry of ICT and National Guidance')
    system_name = models.CharField(max_length=200, default='IT and Communication Cadre Tracking Database')
