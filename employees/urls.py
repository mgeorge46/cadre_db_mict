...
urlpatterns = [
    ...
    path('<int:pk>/submit-verification/', views.submit_for_verification, name='submit_verification'),
    path('<int:pk>/toggle-lock/', views.toggle_section_lock, name='toggle_lock'),
